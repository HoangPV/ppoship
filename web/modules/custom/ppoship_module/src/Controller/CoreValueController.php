 ...
 */
class CoreValueController extends ControllerBase {
  ...
  const ID_CORE_VALUE = 'block_corevalue';
  ...
  public function render() {
    $blockId = $this->pposhipModuleCommon->getBlockAssignId(self::ID_CORE_VALUE);
    $block = $this->pposhipModuleCommon->getRenderedArrayCustomBlock($blockId);
    ...
    foreach ($topNavItems as $index0 => $item) {
      ...
      if ($path === '/ppoship_module/render/corevalue') {
        $current = true;
      }
