 ...
 */
class CultureController extends ControllerBase {
  ...
  const ID_CULTURE = 'block_culture';
  ...
  public function render() {
    $blockId = $this->pposhipModuleCommon->getBlockAssignId(self::ID_CULTURE);
    ...
    foreach ($topNavItems as $index0 => $item) {
      ...
      if ($path === '/ppoship_module/render/culture') {
        $current = true;
      }
